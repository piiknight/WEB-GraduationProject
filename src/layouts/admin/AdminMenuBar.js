        ...
        return (
            <div className="sidebar-menu">
                <div className="sidebar-header">
                    <div className="logo">
                        <a href="index.html" style={{fontSize:'15px'}}><i className="ti-dashboard"/><span>  Trang quản lý</span></a>
                    </div>
                </div>
                        ...
                        <nav>
                            {
                                LocalStorageManager.getMode() == "OWNER" ?
                                    <ul className="metismenu" id="menu">
                                        <li className="active">
                                            <a href="/nn-vd" aria-expanded="true"><i className="ti-shield"/><span>Vật dụng</span></a>
                                        </li>
                                        <li className="active">
                                            <a href="/tiec-nn" aria-expanded="true"><i className="ti-check-box"/><span>Quản lý Tiệc</span></a>
                                        </li>
                                    </ul>
                                    :
                                    ""
