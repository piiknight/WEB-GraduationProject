...
export const search = (inString, keyWords) => {
  const noDiacriticsString = removeDiacritics(inString).toUpperCase();
  const noDiacriticsKeyWords = removeDiacritics(keyWords.trim()).toUpperCase();

  return noDiacriticsString.includes(noDiacriticsKeyWords);
};
