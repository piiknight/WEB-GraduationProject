...
export const UserValidatedForm = withFormik({
    mapPropsToValues: props => {
        return {
            ...mapPropsObjectToValues(props.user),
    ...
    handleSubmit: (values, {setErrors, setSubmitting}) => {
        ...
        if (object.idU) {
            UserService.updateOne(object).then(res => {
                snack.message = "Update";
                handleResponse(res);
            });
        } else {
            UserService.addOne(object).then(res => {
